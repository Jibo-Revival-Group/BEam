...
```
WROTE /path/to/@be/bad-apple/index.js
```
...
- The whole skill folder, especially **`index.js`** and asset dirs (`video/`, `music/`, etc.)
...
- `@be/main-menu/resources/views/*.json`
- `@be/main-menu/resources/icons/*.png`
