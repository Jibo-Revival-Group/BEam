        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (shouldListen) {
                ...
                const listenOptions = {
                    ...
                    ignoreGlobalRules: this.mimConfig.ignoreGlobalRules,
                    ignoreHJ: this.mimConfig.ignoreHJ
                };
                try {
...
class MimConfig {
    ...
    initWithJSON(data) {
        ...
        this.ignoreGlobalRules = data.ignore_global_rules === true;
        this.ignoreHJ = data.ignore_hj === true;
...
module.exports = function (blackboard, notepad, result, emitter) {
    return {
        'meta': {
            ...
            'uri': '/Users/jon/Workspace/jibo/buildsdk/packages/jibo/src/bt/mim/flows/NoInputException.flow'
        },
...
module.exports = function (blackboard, notepad, result, emitter) {
    return {
        'meta': {
            ...
            'uri': '/Users/jon/Workspace/jibo/buildsdk/packages/jibo/src/bt/mim/flows/NoMatchException.flow'
        },
        'f5f79e38-b40a-4c5f-83a6-a62c8af42161': function () {
            return {
                'id': 'f5f79e38-b40a-4c5f-83a6-a62c8af42161',
...
class LightFilter extends PIXI.Filter {
    ...
    update(timestamp, dofValues) {
        ...
        if (eyeTexturePath.endsWith("Default_Eye.png") ||
            ...
            // Softer than stock 1.1 so runtime shading doesn't overpower the baked texture.
            this.amount = 0.5;
        }
        else {
            this.amount = 0;
...
class RemoteService {
    ...
    setRemoteDisabled(disabled) {
        this._remoteDisabled = disabled;
        if (disabled && this._remoteConnection &&
            (this._remoteConnection.isConnected || this._remoteConnection.isAwaitingReconnect)) {
            this.closeConnection(jibo_command_protocol_1.DisconnectCode.RobotError);
        }
    }
    isRemoteDisabled() {
        return this._remoteDisabled;
    }
    init(service, cb) {
        service.host = '127.0.0.1';
    ...
    onMessageIn(message) {
        ...
        if (this._remoteDisabled) {
            if (data.type === 'message' && data.status === Messages_1.IncomingTypes.CONNECTED) {
    ...
    rejectConnection() {
        const code = jibo_command_protocol_1.DisconnectCode.RobotError;
        this.onMessageOut({
            type: 'message',
            status: 'close',
            code,
            reason: jibo_command_protocol_1.DisconnectReason[code]
        });
    }
