...
},{"./commander/components":35}],4:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"./CommandSession":3,"./CommandUtil":5,"./commander/CommandManager":8,"./log":101,"jibo-command-protocol":undefined,"uuid":undefined}],5:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
const jibo_command_protocol_1 = require("jibo-command-protocol");
class CommandUtil {
...
class CommandCreator {
    ...
    commandFromRequestProtocol(data) {
        ...
        switch (body.Type) {
            ...
            case jibo_command_protocol_1.CommandTypes.FetchAsset:
                ...
                break;
            case jibo_command_protocol_1.CommandTypes.UnloadAsset:
                this.createUnloadAsset(commandEntity, request, body);
                break;
    ...
    createSession(commandEntity, request, body) {
        ...
        if (this._permissions.headTouchStopTime) {
            session.headTouchStopTime = this._permissions.headTouchStopTime;
        }
    ...
    createPlay(commandEntity, request, body) {
        if (this._permissions.play) {
            commandEntity.add(new components_1.Play(body.ESML, body.SpeakOptions, body.AutoRuleConfig));
        }
        else {
            request.setAcknowledge(jibo_command_protocol_1.ResponseCode.Forbidden, true);
        }
    ...
    createUnloadAsset(commandEntity, request, body) {
        if (this._permissions.fetchAsset) {
            commandEntity.add(new components_1.UnloadAsset(body.Name));
            commandEntity.add(this._engine.getEntityByName("assetCache").get(components_1.AssetCache));
        }
        else {
            request.setAcknowledge(jibo_command_protocol_1.ResponseCode.Forbidden, true);
...
},{"./components":35,"./core":46,"jibo-command-protocol":undefined}],8:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"../log":101,"./EntityManager":9,"events":undefined}],9:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
const core_1 = require("./core");
...
const JiboTickProvider_1 = require("./core/tick/JiboTickProvider");
...
const LoadAssetSystem_1 = require("./systems/LoadAssetSystem");
const UnloadAssetSystem_1 = require("./systems/UnloadAssetSystem");
...
class EntityManager {
    ...
    addSessionSystems(sessionEntity) {
        ...
        if (this._permissions.fetchAsset) {
            this.engine.addSystem(new LoadAssetSystem_1.default(), SystemPriorities_1.SystemPriorities.load);
            this.engine.addSystem(new UnloadAssetSystem_1.default(), SystemPriorities_1.SystemPriorities.load);
    ...
    start() {
        ...
        if (!this._tickProvider) {
            this._tickProvider = new JiboTickProvider_1.default();
...
},{"./CommandCreator":7,"./components":35,"./core":46,"./core/tick/JiboTickProvider":53,"./systems/AttentionSystem":77,"./systems/CommandSystem":78,"./systems/DisplaySystem":79,"./systems/GetConfigSystem":80,"./systems/HeadTouchSystem":81,"./systems/HotWordSystem":82,"./systems/InterruptSystem":83,"./systems/LightRingSystem":84,"./systems/ListenSystem":85,"./systems/LoadAssetSystem":86,"./systems/LookAtSystem":87,"./systems/MotionStreamSystem":88,"./systems/PersonStreamSystem":89,"./systems/PhotoStreamSystem":90,"./systems/PlaySystem":91,"./systems/RemoteIndicatorSystem":92,"./systems/ScreenTouchSystem":93,"./systems/SessionSystem":94,"./systems/SetConfigSystem":95,"./systems/SystemPriorities":96,"./systems/TakePhotoSystem":97,"./systems/TestSystem":98,"./systems/UnloadAssetSystem":99,"jibo-command-protocol":undefined}],10:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
class AssetCache {
    constructor() {
...
Object.defineProperty(exports, "__esModule", { value: true });
class Play {
    constructor(textInESML, speakOptions, autoRuleConfig) {
        this.textInESML = null;
        this.speakOptions = null;
        this.autoRuleConfig = null;
        ...
        if (autoRuleConfig) {
            this.autoRuleConfig = autoRuleConfig;
        }
    }
}
exports.Play = Play;
...
exports.UnloadAsset = UnloadAsset;
...
var UnloadAsset_1 = require("./UnloadAsset");
exports.UnloadAsset = UnloadAsset_1.UnloadAsset;
...
},{"./AssetCache":10,"./Attention":11,"./Display":12,"./DisplayChange":13,"./FetchAsset":14,"./GetConfig":15,"./HeadTouch":16,"./HotWord":17,"./Interrupt":18,"./LightRing":19,"./Listen":20,"./LookAt":21,"./MotionStream":22,"./PersonStream":23,"./PhotoStream":24,"./Play":25,"./RemoteIndicator":26,"./RequestCommand":27,"./ScreenGesture":28,"./Session":29,"./SetConfig":30,"./TakePhoto":31,"./Target":32,"./Test":33,"./UnloadAsset":34}],36:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"./Dictionary":37,"./NodeList":42,"./NodePool":43}],37:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
class Dictionary {
    constructor() {
...
class Engine {
    constructor() {
        ...
        this.log = log_1.default.createChild('engine');
    }
    addEntity(entity) {
        if (this._entityNames[entity.name]) {
            this.log.error(`The entity name ${entity.name} is already in use by another entity. Not adding to engine.`);
            return;
        }
...
},{"../../log":101,"./ComponentMatchingFamily":36,"./Dictionary":37,"./EntityList":40,"./SystemList":45,"./signals/Signal0":49}],39:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"./Dictionary":37,"./signals/Signal2":51}],40:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
class EntityList {
    add(entity) {
...
},{"./signals/Signal1":50}],43:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
class NodePool {
...
},{"./Engine":38,"./Entity":39,"./Node":41,"./NodeList":42,"./System":44}],47:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
class ListenerNode {
}
...
},{"./ListenerNode":47}],49:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"./SignalBase":52}],50:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
const SignalBase_1 = require("./SignalBase");
...
},{"./SignalBase":52}],51:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
const SignalBase_1 = require("./SignalBase");
...
},{"./SignalBase":52}],52:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
const Dictionary_1 = require("../Dictionary");
...
},{"../Dictionary":37,"./ListenerNodePool":48}],53:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
const Signal1_1 = require("../signals/Signal1");
class JiboTickProvider extends Signal1_1.Signal1 {
    constructor() {
        super();
        this.DESIRED_FREQ = 20;
        this.update = () => {
            this._rafId = requestAnimationFrame(this.update);
            let time = performance.now();
            let timeDiff = (time - this._previousTime);
            if (timeDiff > this._minTimeDiff) {
    ...
    start() {
        ...
        this.playing = true;
        this._rafId = requestAnimationFrame(this.update);
        this._minTimeDiff = 1 / this.DESIRED_FREQ * 1000;
    }
    stop() {
        cancelAnimationFrame(this._rafId);
    }
}
exports.default = JiboTickProvider;

},{"../signals/Signal1":50}],54:[function(require,module,exports){
"use strict";
...
},{"../components":35,"../core/Node":41}],55:[function(require,module,exports){
"use strict";
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
...
},{"../components":35,"../core/Node":41}],56:[function(require,module,exports){
"use strict";
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
...
},{"../components":35,"../core/Node":41}],57:[function(require,module,exports){
"use strict";
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
...
},{"../components":35,"../core/Node":41}],58:[function(require,module,exports){
"use strict";
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
...
},{"../components":35,"../core/Node":41}],59:[function(require,module,exports){
"use strict";
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
...
},{"../components":35,"../core/Node":41}],60:[function(require,module,exports){
"use strict";
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
...
},{"../components":35,"../core/Node":41}],61:[function(require,module,exports){
"use strict";
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
...
},{"../components":35,"../core/Node":41}],62:[function(require,module,exports){
"use strict";
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
...
},{"../components":35,"../core/Node":41}],63:[function(require,module,exports){
"use strict";
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
...
},{"../components":35,"../core/Node":41}],64:[function(require,module,exports){
"use strict";
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
...
},{"../components":35,"../core/Node":41}],65:[function(require,module,exports){
"use strict";
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
...
},{"../components":35,"../core/Node":41}],66:[function(require,module,exports){
"use strict";
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
...
},{"../components":35,"../core/Node":41}],67:[function(require,module,exports){
"use strict";
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
...
},{"../components":35,"../core/Node":41}],68:[function(require,module,exports){
"use strict";
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
...
},{"../components":35,"../core/Node":41}],69:[function(require,module,exports){
"use strict";
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
...
},{"../components":35,"../core/Node":41}],70:[function(require,module,exports){
"use strict";
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
...
},{"../components":35,"../core/Node":41}],71:[function(require,module,exports){
"use strict";
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
...
},{"../components":35,"../core/Node":41}],72:[function(require,module,exports){
"use strict";
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
...
},{"../components":35,"../core/Node":41}],73:[function(require,module,exports){
"use strict";
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
...
},{"../components":35,"../core/Node":41}],74:[function(require,module,exports){
"use strict";
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
...
},{"../components":35,"../core/Node":41}],75:[function(require,module,exports){
"use strict";
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
...
const Node_1 = require("../core/Node");
const components_1 = require("../components");
class UnloadAssetNode extends Node_1.Node {
}
__decorate([
    Node_1.keep(components_1.RequestCommand)
], UnloadAssetNode.prototype, "request", void 0);
__decorate([
    Node_1.keep(components_1.UnloadAsset)
], UnloadAssetNode.prototype, "unloadAsset", void 0);
__decorate([
    Node_1.keep(components_1.AssetCache)
], UnloadAssetNode.prototype, "assetCache", void 0);
exports.UnloadAssetNode = UnloadAssetNode;

},{"../components":35,"../core/Node":41}],76:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
var UnloadAssetNode_1 = require("./UnloadAssetNode");
exports.UnloadAssetNode = UnloadAssetNode_1.UnloadAssetNode;
...
},{"./AttentionNode":54,"./DisplayNode":55,"./FetchAssetNode":56,"./GetConfigNode":57,"./HeadTouchNode":58,"./HotWordNode":59,"./InterruptNode":60,"./LightRingNode":61,"./ListenNode":62,"./LookAtNode":63,"./MotionStreamNode":64,"./PersonStreamNode":65,"./PhotoStreamNode":66,"./PlayNode":67,"./RemoteIndicatorNode":68,"./RequestCommandNode":69,"./ScreenGestureNode":70,"./SessionNode":71,"./SetConfigNode":72,"./TakePhotoNode":73,"./TestNode":74,"./UnloadAssetNode":75}],77:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
const core_1 = require("../core");
...
class AttentionSystem extends core_1.System {
    ...
    update(time) {
        ...
        for (node; node; node = node.next) {
            ...
            else if (!node.attention.active) {
                let attention = node.attention;
                attention.active = true;
                jibo_1.jiboRef.jibo.expression.pushAttentionMode(this.convertMode(attention.mode))
                    .then((handle) => {
                    if (attention.active) {
...
},{"../../jibo":100,"../core":46,"../nodes":76,"jibo-command-protocol":undefined}],78:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
const core_1 = require("../core");
const nodes_1 = require("../nodes");
...
class CommandSystem extends core_1.System {
    ...
    update(time) {
        ...
        if (sessionNode) {
            if (sessionNode.session.reconnection) {
                for (let i = 0; i < sessionNode.session.storedEvents.length; i++) {
                    sessionNode.session.sendMethod(sessionNode.session.storedEvents[i]);
                }
                sessionNode.session.storedEvents.length = 0;
                sessionNode.session.reconnection = false;
            }
            for (node; node; node = node.next) {
                if (node.request.isDirty) {
                    if (!node.request.acknowledged) {
                        this.sendEvent(sessionNode.session, this.createAcknowledgement(sessionNode.session, node.request));
                        node.request.acknowledged = true;
                    }
                    if (node.request.responses.length > 0) {
                        this.sendMessages(node.request, sessionNode.session);
                    }
                    if (node.request.complete) {
...
},{"../../CommandUtil":5,"../core":46,"../nodes":76}],79:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
const core_1 = require("../core");
const jibo_1 = require("../../jibo");
...
},{"../../jibo":100,"../core":46,"../nodes":76,"jibo-command-protocol":undefined}],80:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
const core_1 = require("../core");
const nodes_1 = require("../nodes");
...
class GetConfigSystem extends core_1.System {
    ...
    getConfigState(getConfig) {
        return new Promise((resolve, reject) => {
            ...
            mixers.Master = jibo_1.jiboRef.jibo.volume.currentVolume / 10;
...
},{"../../jibo":100,"../core":46,"../nodes":76,"jibo-command-protocol":undefined,"jibo-common-types":undefined}],81:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
const core_1 = require("../core");
const jibo_1 = require("../../jibo");
...
},{"../../jibo":100,"../core":46,"../nodes":76,"jibo-command-protocol":undefined}],82:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
const core_1 = require("../core");
const jibo_1 = require("../../jibo");
...
},{"../../CommandUtil":5,"../../jibo":100,"../components":35,"../core":46,"../nodes":76,"jibo-command-protocol":undefined}],83:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
const core_1 = require("../core");
const nodes_1 = require("../nodes");
...
},{"../components":35,"../core":46,"../nodes":76,"jibo-command-protocol":undefined}],84:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
const core_1 = require("../core");
const jibo_1 = require("../../jibo");
...
},{"../../jibo":100,"../core":46,"../nodes":76}],85:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
const core_1 = require("../core");
const jibo_1 = require("../../jibo");
        ...
        for (node; node; node = node.next) {
            ...
            if (node.next) {
                ...
                if (!listen.mim) {
                    ...
                    let status = listen.mim.update();
                    if (status !== jibo_1.jiboRef.jibo.bt.Status.IN_PROGRESS) {
                        if (status === jibo_1.jiboRef.jibo.bt.Status.INTERRUPTED) {
                            let response = {
                                Event: jibo_command_protocol_1.AsyncCommandEvent.Stop,
                                StopReason: jibo_command_protocol_1.ListenStopReasons.Interrupted,
                            };
                            request.addResponse(response, true);
                        }
                        else {
                            if (node.listen.speech === null) {
                                let response = {
                                    Event: jibo_command_protocol_1.AsyncCommandEvent.Stop,
                                    StopReason: jibo_command_protocol_1.ListenStopReasons.NoInput,
                                };
                                request.addResponse(response, true);
                            }
                            else {
                                if (node.listen.speech.text === "") {
                                    let response = {
                                        Event: jibo_command_protocol_1.AsyncCommandEvent.Stop,
                                        StopReason: jibo_command_protocol_1.ListenStopReasons.NoMatch,
                                    };
                                    request.addResponse(response, true);
                                }
                                else {
...
},{"../../CommandUtil":5,"../../jibo":100,"../core":46,"../nodes":76,"jibo-command-protocol":undefined}],86:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
const core_1 = require("../core");
const jibo_1 = require("../../jibo");
...
class LoadAssetSystem extends core_1.System {
    constructor() {
        super();
        this.onAdded = (node) => {
        };
        ...
        for (node; node; node = node.next) {
            ...
            if (!request.acknowledged) {
                if (!this.thereIsFreeMemory()) {
                    let code = jibo_command_protocol_1.ResponseCode.NotAcceptable;
                    request.setAcknowledge(code, true, jibo_command_protocol_1.FetchAssetErrorDetails.OutOfMemory);
                }
                else {
                    let assetToken = jibo_1.jiboRef.jibo.loader.load(this.buildAsset(fetchAsset), (err, res) => {
                        let response;
                        if (err) {
                            response = {
...
exports.default = LoadAssetSystem;

},{"../../jibo":100,"../components":35,"../core":46,"../nodes":76,"jibo-command-protocol":undefined,"os":undefined}],87:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
const core_1 = require("../core");
const jibo_1 = require("../../jibo");
...
},{"../../jibo":100,"../core":46,"../nodes":76,"@jibo/three":undefined,"jibo-command-protocol":undefined}],88:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
const core_1 = require("../core");
const jibo_1 = require("../../jibo");
        ...
        for (let entity of lpsData.entities) {
            if (entity.description = "motion") {
                ...
                if (entity.parts.length > 0) {
                    if (entity.parts[0].value.trackers.length > 0) {
...
},{"../../jibo":100,"../core":46,"../nodes":76,"jibo-command-protocol":undefined}],89:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
const core_1 = require("../core");
const jibo_1 = require("../../jibo");
...
},{"../../jibo":100,"../core":46,"../nodes":76,"jibo-command-protocol":undefined}],90:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
const uuid = require("uuid");
const jibo_command_protocol_1 = require("jibo-command-protocol");
...
},{"../../jibo":100,"../core":46,"../nodes":76,"jibo-command-protocol":undefined,"uuid":undefined}],91:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
const core_1 = require("../core");
const jibo_1 = require("../../jibo");
    ...
    playESML(play) {
        return new Promise((resolve) => {
            ...
            if (play.audioId) {
                ...
                jibo.embodied.speech.speak(play.textInESML, play.speakOptions, play.autoRuleConfig)
                    .then(() => {
                    let response = {
                        Event: jibo_command_protocol_1.AsyncCommandEvent.Stop
                    };
...
},{"../../jibo":100,"../core":46,"../nodes":76,"jibo-command-protocol":undefined,"jibo-node-xml":undefined}],92:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
const core_1 = require("../core");
const nodes_1 = require("../nodes");
...
},{"../../jibo":100,"../core":46,"../nodes":76}],93:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
const core_1 = require("../core");
const nodes_1 = require("../nodes");
...
class ScreenTouchSystem extends core_1.System {
    ...
    getGesture() {
        ...
        let yMin = 720;
        const tolerance = 50;
        const first = this.screenCoordsArray[0];
        const last = this.screenCoordsArray[this.screenCoordsArray.length - 1];
        const xStart = first[0];
        const xEnd = last[0];
        const yStart = first[1];
        const yEnd = last[1];
        for (const point of this.screenCoordsArray) {
            if (point[0] < xMin) {
                xMin = point[0];
            }
            if (point[0] > xMax) {
...
},{"../core":46,"../nodes":76,"jibo-command-protocol":undefined}],94:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
const core_1 = require("../core");
const nodes_1 = require("../nodes");
...
class SessionSystem extends core_1.System {
    constructor() {
        ...
        this.onRemoved = (node) => {
            ...
            jibo_1.jiboRef.jibo.action.resetHoldToQuitTime();
        };
    }
    addToEngine(engine) {
        ...
        for (node; node; node = node.next) {
            if (node.next) {
                ...
                if (request.acknowledged) {
                    ...
                    if (node.session.headTouchStopTime) {
                        jibo_1.jiboRef.jibo.action.setHoldHeadToQuitDuration(node.session.headTouchStopTime);
                    }
                }
            }
        }
...
},{"../../jibo":100,"../core":46,"../nodes":76,"jibo-command-protocol":undefined}],95:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
const core_1 = require("../core");
const nodes_1 = require("../nodes");
...
class SetConfigSystem extends core_1.System {
    ...
    setConfigOptions(options) {
        return new Promise((resolve, reject) => {
            jibo_1.jiboRef.jibo.volume.changeVolume('volumeToValue', options.Mixer * 10);
            let response = {
                Event: jibo_command_protocol_1.AsyncCommandEvent.Stop
            };
            resolve(response);
...
},{"../../jibo":100,"../core":46,"../nodes":76,"jibo-command-protocol":undefined}],96:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
    ...
    _playSound() {
        return __awaiter(this, void 0, void 0, function* () {
            yield new Promise((resolve, reject) => {
                ...
                const sound = jibo_1.jiboRef.jibo.loader.cached('photo', 'global-gui');
                if (sound) {
                    sound.play();
                    resolve();
                }
...
},{"../../jibo":100,"../core":46,"../nodes":76,"jibo-cai-utils":undefined,"jibo-command-protocol":undefined,"uuid":undefined}],98:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
const core_1 = require("../core");
const nodes_1 = require("../nodes");
...
},{"../core":46,"../nodes":76,"jibo-command-protocol":undefined}],99:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
const core_1 = require("../core");
const jibo_1 = require("../../jibo");
const nodes_1 = require("../nodes");
const jibo_command_protocol_1 = require("jibo-command-protocol");
class UnloadAssetsSystem extends core_1.System {
    constructor() {
        super();
    }
    addToEngine(engine) {
        this.engine = engine;
        this.nodes = this.engine.getNodeList(nodes_1.UnloadAssetNode);
    }
    update(time) {
        let node = this.nodes.head;
        for (node; node; node = node.next) {
            let unloadAsset = node.unloadAsset;
            let request = node.request;
            if (!request.acknowledged) {
                if (!unloadAsset.name || !node.assetCache.assetTokens.has(unloadAsset.name)) {
                    const code = jibo_command_protocol_1.ResponseCode.NotAcceptable;
                    request.setAcknowledge(code, true, jibo_command_protocol_1.UnloadAssetErrorDetails.InvalidName);
                }
                else {
                    let assetToken = node.assetCache.assetTokens.get(unloadAsset.name);
                    if (assetToken) {
                        jibo_1.jiboRef.jibo.loader.unload(assetToken.assetToken);
                        node.assetCache.assetTokens.delete(unloadAsset.name);
                        let response;
                        response = {
                            Event: jibo_command_protocol_1.UnloadAssetEvents.UnloadAssetDone,
                            Detail: unloadAsset.name
                        };
                        request.addResponse(response, true);
                    }
                }
...
exports.default = UnloadAssetsSystem;

},{"../../jibo":100,"../core":46,"../nodes":76,"jibo-command-protocol":undefined}],100:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
let _jibo;
class jiboRef {
...
},{"jibo-log":undefined}],102:[function(require,module,exports){
"use strict";
function __export(m) {
...
var LoadAssetSystem_1 = require("./commander/systems/LoadAssetSystem");
exports.LoadAssetSystem = LoadAssetSystem_1.default;
...
class CommandLibrary {
    ...
    connect(commandConnection) {
        ...
        jibo_1.jiboRef.jibo.analytics.track('Remote Connected', { app_id: sourceId });
    ...
    messageReceived(data) {
        ...
        timer.start('startCommand');
        this._sessionManager.startCommand(data);
        let debugTime = timer.stop('startCommand');
        if (debugTime > SLOW_COMMAND) {
            log_1.default.debug(`Command Performance : time to add command ${data.Command.Type} : ${debugTime} ms`);
        }
    }
    responseFailed(message) {
    ...
    startSession() {
        ...
        log_1.default.debug('Command Performance : time to start session : ' + timer.stop('sessionStart') + 'ms');
    }
    awaitReconnect() {
    ...
    endSession() {
        jibo_1.jiboRef.jibo.analytics.track('Remote Disconnected', { app_id: this._activeSourceId });
        this._sessionManager.endSession();
        this._activeProxy = null;
        if (this._activeConnection) {
            this._activeConnection.onReady.off(this.startSession);
    ...
    createPermissionsFromACO(aco) {
        ...
        if (aco.version === jibo_command_protocol_1.ProtocolVersions.v1) {
            permissions = {
                ...
                headTouchStopTime: aco.remoteConfig && aco.remoteConfig.headTouchStopTime,
...
},{"./CommandConnector":1,"./CommandProxy":2,"./CommandSessionManager":4,"./CommandUtil":5,"./ErrorFormatting":6,"./commander/components":35,"./commander/systems/AttentionSystem":77,"./commander/systems/CommandSystem":78,"./commander/systems/DisplaySystem":79,"./commander/systems/HeadTouchSystem":81,"./commander/systems/HotWordSystem":82,"./commander/systems/InterruptSystem":83,"./commander/systems/LightRingSystem":84,"./commander/systems/ListenSystem":85,"./commander/systems/LoadAssetSystem":86,"./commander/systems/MotionStreamSystem":88,"./commander/systems/PersonStreamSystem":89,"./commander/systems/RemoteIndicatorSystem":92,"./commander/systems/SessionSystem":94,"./commander/systems/TestSystem":98,"./jibo":100,"./log":101,"@types/jibo-command-protocol/commandSchema.json":undefined,"ajv":undefined,"ajv/lib/refs/json-schema-draft-04.json":undefined,"application-metrics":undefined,"jibo-command-protocol":undefined}]},{},[102])(102)
});
